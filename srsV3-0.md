...
***4.4.1.1*** Verify that the login page shall provide the ability to login to an account using login credentials. [3.4.1.1]
Method: Test
What: Attempt to login to an account using both valid and invalid credentials and verify that the happy path is achieved. 
***4.4.1.2*** Verify that the system shall send an automated password recovery email to the user on request. [3.4.1.2] 
Method: Test
What: Attempt to recover a password and confirm that the recovery email is sent. 
...
***4.4.2.1*** Verify that the home page shall provide access to myTrainer. [3.4.2.1]
Method: Test
What: The application shall take the user to the myTrainer page after the myTrainer button has been selected while on the home page.
***4.4.2.2*** Verify that the home page shall provide access to myWorkouts. [3.4.2.2]
Method: Test
What: The application shall take the user to the myWorkouts page after the myWorkouts button has been pressed while on the home page.
***4.4.2.3*** Verify that the home page shall provide access to myVideos. [3.4.2.3]
Method: Test
What: The application shall take the user to the myVideos page after the myVideos button has been pressed while on the home page.
***4.4.2.4*** Verify that the home page shall provide access to myGymMap. [3.4.2.4]
Method: Test
What: The application shall take the user to the myGymMap page after the myGymMap button has been while on the home page.
***4.4.2.5*** Verify that the login page shall provide the user with the ability to recover a lost password. [3.4.2.5]
Method: Test
...
***4.4.2.6*** Verify that the login page shall provide the user with the ability to create an account. [3.4.2.6]
Method: Test
What: The application shall allow the user to create an account with their individual credentials and access the apps features.
***4.4.2.7*** Verify that the login page shall display an error message when invalid credentials are submitted. [3.4.2.7]
Method: Test
What: When a user attempts to log in with invalid credentials, the login page shall display an error message that the credentials were invalid and re-prompt for valid credentials.
***4.4.2.8*** Verify that the system shall check the login credentials against the database. [3.4.2.8]
Method: Test
What: The user shall only be able to login and view the home page after they provide valid login credentials.
...
***4.4.3.1*** Verify that the signup page shall inform the user of password requirements. [3.4.3.1]
Method: Test
What: When creating an account verify that the message for password requirements appears.
***4.4.3.2*** Verify that the login page shall allow the user to enter login credentials [3.4.3.2]
Method: Test
What: Attempt to enter login credentials on the login page.
...
***4.4.4.1*** Verify that the system shall have the ability to process login credentials. [3.4.4.1]
Method: Test
What: The system shall store the login credentials by allowing the user to re-login multiple times.
...
***4.4.5.1*** Verify that the UserData database table shall have a Google authentication key from the Google third party login. [3.4.5.1]
Method: Inspection
What: Inspect the UserData table to ensure that it can collect and store google authentication keys.
***4.4.5.2*** Verify that the UserData database table shall store usernames [3.4.5.2]
Method: Inspection
What: Inspect the UserData table to ensure that it can collect and store usernames.
***4.4.5.3*** Verify that the UserData database table shall store the passwords [3.4.5.3]
Method: Inspection
What: Inspect the UserData table to ensure that it can collect and store passwords.
***4.4.5.4*** Verify that the database shall be accessed by the login page when user credentials are submitted through the login page. [3.4.5.4]
Method: Test
What: Have the tester attempt to login with a valid and invalid credentials. Check if the system allows valid credentials to login and doesn't allow invalid credentials to login.
***4.4.5.5*** Verify that the database shall keep the login credentials of users confidential. [3.4.5.5]
Method: Test
What: Have a "hacker" try to access personal information in the database. Run this test until the database is secure from all attacks.
...
***4.4.6.1*** Verify that the myJym app shall be completed in its entirety by the end of Jared's Senior Project class. [3.4.6.1]
Method: Demo
What: Show that the myJym app is completed within the given timeframe.
***4.4.6.2*** Verify that the budget for the myJym app shall be $0.00. [3.4.6.2]
Method: Demo
What: Show that there has been no money spent on the development of the application.
...
***4.4.7.1.1*** Verify that the app shall require the compliance of personal trainers. [3.4.7.1.1]
Method: Demo
What: Demonstrate the compliance of personal trainers in the use of the application.
***4.4.7.1.2*** Verify that the app shall require the adminitrator. [3.4.7.1.2]
Method: Demo
What: Demonstrate the administrator requirements in the use of the application.

##### 4.4.7.2 Availability Verification <a name="4.4.7.2-availability-verification" />
Verification of the systems uptime for users.
***4.4.7.2.1*** Verify that the myJym app shall be available on demand of the user. [3.4.7.2.1]
Method: Demo
What: Access the myJym application at various times to ensure that it is available whenever needed.
...
***4.4.7.3.1*** Verify that the system shall encrypt user accounts. [3.4.7.3.1]
Method: Inspection
What: Inspect the code to ensure that the user account information is properly encrypted.
***4.4.7.3.2*** Verify that the system shall use a protocol to secure online communications. [3.4.7.3.2]
Method: Inspection
What: Inspect code to ensure that a protocol is properly used to secure online communication.
...
***4.4.7.4.1*** Verify that the application shall be built with a programming language that can be ported to both iOS and Android. [3.4.7.4.1]
Method: Inspection
What: Inspect the code to ensure that it can be ported to iOS and Android.
